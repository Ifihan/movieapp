...
# !!! Main.UserApp is configured as an alias for Main.Movieapp and you might encounter it in some tests
using Main.Movieapp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Movieapp tests" begin
  @includetests ARGS
end
